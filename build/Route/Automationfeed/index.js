...
var index_1 = __importDefault(require("../../models/automationfeeds/index"));
var Route = /** @class */ (function () {
    function Route() {
        var _this = this;
        this.path = "automationfeed";
        this.router = express_1.default.Router();
        this.schema = index_1.default;
        this.addAutomationFeed = function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
            var roleRes, data, error_1;
        ...
        this.getAll = function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, page, items_per_page, data, dataTotal, search, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.schema.find({ title: { $regex: search, $options: "i" } }).sort({ createdAt: -1 }).skip((Number(page) - 1) * Number(items_per_page)).limit(Number(items_per_page))];
                    case 1:
                        data = _b.sent();
                        return [4 /*yield*/, this.schema.find({ title: { $regex: search, $options: "i" } }).count()];
                    case 2:
                        dataTotal = _b.sent();
                        return [3 /*break*/, 6];
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, this.schema.find({ title: { $regex: search, $options: "i" } }).sort({ createdAt: -1 }).limit(Number(items_per_page))];
                    case 8:
                        data = _b.sent();
                        return [4 /*yield*/, this.schema.find({ title: { $regex: search, $options: "i" } }).count()];
                    case 9:
        ...
        this.getTotalAutomationfeed = function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
            var data, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        this.update = function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.schema.findByIdAndUpdate({ _id: request.params._id }, { $set: request.body }, { new: true })];
                    case 1:
                        data = _a.sent();
    ...
    Route.prototype.initializeRoutes = function () {
        this.router.post("/".concat(this.path, "/"), this.addAutomationFeed);
        this.router.get("/".concat(this.path, "/:_id"), this.getById);
        this.router.get("/getTotal/".concat(this.path, "/"), this.getTotalAutomationfeed);
