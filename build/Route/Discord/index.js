...
var Route = /** @class */ (function () {
    function Route() {
        ...
        this.getTotalDiscord = function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
            var data, error_2;
    ...
    Route.prototype.initializeRoutes = function () {
        ...
        this.router.get("/getTotal/".concat(this.path, "/"), checkAuth_1.checkRoleAdmin, this.getTotalDiscord);
