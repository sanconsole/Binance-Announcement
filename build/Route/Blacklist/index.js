...
var newReutersBlacklist_1 = __importDefault(require("../../models/Blacklist/newReutersBlacklist"));
var Route = /** @class */ (function () {
    function Route() {
        ...
        this.getTotalBlacklist = function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
            var data, error_2;
        ...
        this.add = function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
            var blacklistRes, data, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        blacklistRes = new this.schema(request.body);
                        return [4 /*yield*/, blacklistRes.save()];
                    case 1:
                        data = _a.sent();
                        response.status(200).json({
                            status: true,
    ...
    Route.prototype.initializeRoutes = function () {
        ...
        this.router.get("/getTotal/".concat(this.path, "/"), this.getTotalBlacklist);
