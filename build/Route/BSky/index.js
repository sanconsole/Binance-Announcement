...
var BSkyRoute = /** @class */ (function () {
    function BSkyRoute() {
        var _this = this;
        this.path = "bsky";
        this.router = express_1.default.Router();
        this.schema = bsky_1.default;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.schema
                                ...
                                .sort({ createdAt: -1 })
                                .skip((Number(page) - 1) * Number(items_per_page))
                    ...
                    case 2:
                        dataTotal = _b.sent();
                        return [3 /*break*/, 6];
                    case 3: return [4 /*yield*/, this.schema
                            .find({})
                            .sort({ createdAt: -1 })
                            .skip((Number(page) - 1) * Number(items_per_page))
                            .limit(Number(items_per_page))];
                    ...
                    case 9:
                        dataTotal = _b.sent();
                        return [3 /*break*/, 13];
                    case 10: return [4 /*yield*/, this.schema
                            .find({})
                            .sort({ createdAt: -1 })
                            .limit(Number(items_per_page))];
                    case 11:
        ...
        this.getTotalBlueSky = function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
            var data, error_3;
        ...
        this.add = function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, hooks_1.addEncryptedDataToList)(this.path, this.schema, request, response)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
        ...
        this.update = function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.schema.findByIdAndUpdate({ _id: request.params._id }, {
                                $set: {
                                    is_active: request.body.is_active,
                                    automation_feeds: request.body.automation_feeds,
        ...
        this.delete = function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.schema.findByIdAndDelete({
    ...
    BSkyRoute.prototype.initializeRoutes = function () {
        this.router.get("/".concat(this.path, "/"), checkAuth_1.checkRoleAdmin, this.getlist);
        this.router.get("/getTotal/".concat(this.path, "/"), checkAuth_1.checkRoleAdmin, this.getTotalBlueSky);
        this.router.get("/".concat(this.path, "/:_id"), checkAuth_1.checkRoleAdmin, this.getById);
        this.router.post("/".concat(this.path), checkAuth_1.checkRoleAdmin, this.add);
        this.router.put("/".concat(this.path, "/:_id"), checkAuth_1.checkRoleAdmin, this.update);
        this.router.delete("/".concat(this.path, "/:_id"), checkAuth_1.checkRoleAdmin, this.delete);
    };
    return BSkyRoute;
}());
exports.default = BSkyRoute;
