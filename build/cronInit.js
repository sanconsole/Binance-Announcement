...
exports.BinanceAnnouncementsCronJob = exports.cronInit = void 0;
...
var cronInit = function () {
    ...
    if (ENVIRONMENT_IS_PRODUCTION == "false") {
        exports.BinanceAnnouncementsCronJob.start();
    }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, workers_1.fetchBinanceAnnouncements)()];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
                console.error("Error in Binance announcements cron job:", error_1);
                return [3 /*break*/, 3];
